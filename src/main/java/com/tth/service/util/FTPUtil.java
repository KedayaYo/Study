package com.tth.service.util;

import cn.hutool.core.util.CharsetUtil;
import com.tth.service.async.test.exception.BusinessException;
import com.tth.service.service.common.FTPPoolService;
...
public class FTPUtil {
    ...
    public byte[] downloadFile(String filePath) {
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
            ...
            if (inputStream == null) {
                log.error("FTP server 文件流获取失败: " + filePath + ", FTP 响应码: " + ftpClient.getReplyCode());
                throw new BusinessException("FTP server 文件流获取失败: " + filePath + ", FTP 响应码: " + ftpClient.getReplyCode());
            }
            ...
            if (!success) {
                log.error("FTP server 文件下载失败: " + filePath + "; FTP 响应码: " + ftpClient.getReplyCode());
                throw new BusinessException("FTP server 文件下载失败: " + filePath + "; FTP 响应码: " + ftpClient.getReplyCode());
            }

            return outputStream.toByteArray();
        } catch (IOException e) {
            log.error("FTP server 文件下载失败: " + filePath, e);
            throw new BusinessException("FTP server 文件下载失败: " + filePath, e);
        }
        // finally {
